<template>
  <div class="card waveCard">
    <div class="firstRow flex-center">
      <button @click="emit('waveDeleted')" class="icon-btn btn">
        <delete-icon :size="30" class="icon" />
      </button>
    </div>

    <div class="centerCol">
      <GSelector @change="onWaveChangeCB" v-model="wave.form" :items="waveForms"></GSelector>
    ...
    <div class="rightCol flex-center">
      <button class="icon-btn btn" @click="playWaveBtn">
