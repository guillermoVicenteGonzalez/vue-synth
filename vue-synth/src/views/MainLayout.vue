    ...
    <div class="leftMenu">
      <div class="waveCardList">
        <waveList
          ...
          @refresh-waves="onWaveUpdated"
        ></waveList>
      </div>

      <div class="leftMenuActions">
        <button class="btn newWaveBtn default-btn" @click="createNewWave">
    ...
    <section class="mainSection">
      <GCard>
        <template v-slot:body>
          <MainCanvas :waves="waves"></MainCanvas>
        </template>

        <template v-slot:actions>
          <button class="btn default-btn" @click="playSound()">
